...
$q2 = $mysqli->query("CREATE VIEW recGame AS SELECT video_games.Title, video_games.Developer_Name, video_games.Publisher_Name, video_games.Reviews, video_games.ESRB_Rating, video_games.Platform, video_games.Release_Date, video_games.Price, video_games.Genre FROM game_log, video_games WHERE video_games.Title != game_log.Title");
$q3 = $mysqli->query("CREATE VIEW recGame2 AS SELECT recGame.Title, recGame.Developer_Name, recGame.Publisher_Name, recGame.Reviews, recGame.ESRB_Rating, recGame.Platform, recGame.Release_Date, recGame.Price, recGame.Genre FROM recGame WHERE recGame.Genre LIKE '%$f1%'");
